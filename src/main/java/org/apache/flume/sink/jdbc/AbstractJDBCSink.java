...
public abstract class AbstractJDBCSink extends AbstractSink implements Configurable {
	 ...
	 * processing starts. It allows subclasses to get ready for event
	 * processing.
	 * 
	 * @throws SQLException
	 */
	 ...
	 * @throws Exception
	 *             on any sort of processing problem - connection, conversion,
	 *             etc
	 */
	...
	public Status process() throws EventDeliveryException {
		...
		try {
			...
			try {
				...
				LOG.info("Exception in rollback. Rollback might not have been successful.",e);
			}

			LOG.info("Failed to commit transaction. Transaction rolled back.",e);
